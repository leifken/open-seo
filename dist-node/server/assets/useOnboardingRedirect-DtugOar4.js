...
import { h as GoogleGlyphMuted, i as getGscGrantStatus, G as GoogleGlyph, s as startGoogleLink } from "./startGoogleLink-FLOrvW1P.js";
import { g as getProjects } from "./projects-DdfbVHsT.js";
import { s as setLastProjectId, g as getLastProjectId } from "./active-project-DUKzBpe_.js";
import { C as CreateProjectModal } from "./CreateProjectModal-DKRvYpVH.js";
import { s as samSessionsQueryOptions, i as invalidateSamSessions, c as createSamSession, a as archiveSamSession } from "./samQueries-Coo8RfEC.js";
import { T as ThemePreferenceMenuItems } from "./ThemePreferenceMenuItems-DiqeZ0dq.js";
import { u as useSession, t as signOutAndRedirect, Y as onboardingAnswersQueryOptions, ag as dismissGscNudge, c as captureClientEvent, l as createSsrRpc } from "./router-CC5LdN6j.js";
import { aC as isHostedClientAuthMode, bq as BILLING_ROUTE, i as createServerFn, aD as isEmailVerificationBypassed } from "../entry.js";
      ...
      /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "mx-3 h-6 w-px bg-gradient-to-b from-transparent via-[#8C9BB6] to-transparent" }),
            /* @__PURE__ */ jsx("span", { className: "brand-appname font-mono text-[0.78rem] font-semibold uppercase tracking-[0.16em]", children: "SEO" })
          ]
        }
      ),
...
function MobileTopBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-1 border-b border-base-300 bg-base-100 px-2 py-1.5 md:hidden", children: [
    ...
    /* @__PURE__ */ jsxs(Link, { to: "/", className: "ml-1 flex items-center", "aria-label": "LEIFKEN SEO", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          src: "/brand/leifken-lang-standard.svg",

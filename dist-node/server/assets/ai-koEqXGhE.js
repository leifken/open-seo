...
import { b6 as getAuthMode, aC as isHostedClientAuthMode } from "../entry.js";
import { c as captureClientEvent } from "./router-CC5LdN6j.js";
...
function AiPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-full overflow-auto bg-base-100 px-4 py-12 md:px-6 md:py-16 pb-24 md:pb-12", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl", children: [
    ...
    getAuthMode("hosted") === "cloudflare_access" ? /* @__PURE__ */ jsxs("div", { className: "alert alert-warning mt-6 text-sm", role: "alert", children: [
